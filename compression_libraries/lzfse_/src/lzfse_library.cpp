...
bool LzfseLibrary::CheckOptions(const Options &options,
                                const bool &compressor) {
  bool result{true};
  return result;
}

bool LzfseLibrary::SetOptionsCompressor(const Options &options) {
...
bool LzfseLibrary::SetOptionsDecompressor(const Options &options) {
...
void LzfseLibrary::GetCompressedDataSize(char *uncompressed_data,
