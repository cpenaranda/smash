...
void LzfxLibrary::GetCompressionLevelInformation(
...
void LzfxLibrary::GetWindowSizeInformation(
...
void LzfxLibrary::GetModeInformation(
...
void LzfxLibrary::GetWorkFactorInformation(
...
void LzfxLibrary::GetShuffleInformation(
...
void LzfxLibrary::GetNumberThreadsInformation(
...
void LzfxLibrary::GetBackReferenceBitsInformation(
