...
bool XpackLibrary::GetNumberThreadsInformation(
...
std::string XpackLibrary::GetModeName(const uint8_t &mode) {
  return CompressionLibrary::GetDefaultModeName();
}

std::string XpackLibrary::GetShuffleName(const uint8_t &shuffle) {
