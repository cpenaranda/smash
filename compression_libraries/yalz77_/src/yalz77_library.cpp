...
bool Yalz77Library::SetOptionsCompressor(const Options &options) {
...
bool Yalz77Library::SetOptionsDecompressor(const Options &options) {
...
void Yalz77Library::GetCompressedDataSize(char *uncompressed_data,
                                          uint64_t uncompressed_size,
                                          uint64_t *compressed_size) {
  // There is no way to obtain with Yalz77
...
void Yalz77Library::GetDecompressedDataSize(char *compressed_data,
                                            uint64_t compressed_size,
...
bool Yalz77Library::GetModeInformation(
...
bool Yalz77Library::GetWorkFactorInformation(
...
bool Yalz77Library::GetShuffleInformation(
...
bool Yalz77Library::GetNumberThreadsInformation(
...
std::string Yalz77Library::GetModeName(const uint8_t &mode) {
  return CompressionLibrary::GetDefaultModeName();
}

std::string Yalz77Library::GetShuffleName(const uint8_t &shuffle) {
