...
void ZstdLibrary::GetCompressionLevelInformation(
...
void ZstdLibrary::GetWindowSizeInformation(
...
void ZstdLibrary::GetModeInformation(
...
void ZstdLibrary::GetWorkFactorInformation(
...
void ZstdLibrary::GetShuffleInformation(
...
void ZstdLibrary::GetNumberThreadsInformation(
...
void ZstdLibrary::GetBackReferenceBitsInformation(
